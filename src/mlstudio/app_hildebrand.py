"""app_hildebrand.py - Student Performance Prediction.

A custom supervised regression project created by Tiffany Hildebrand.

This app predicts student scores based on study habits and previous performance.

Process:
    - Load a student performance dataset.
    - Inspect and prepare the data.
    - Train a supervised regression model.
    - Evaluate model performance.
    - Predict one new student's score.
    - Create charts showing feature relationships.
...
OBS:
  ...
  This is my customized version of the example project.
  I copied the original example app and modified the prediction case
  to test a new student profile.
"""
